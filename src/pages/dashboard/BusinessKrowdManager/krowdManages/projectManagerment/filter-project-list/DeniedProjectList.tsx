...
import DeniedProjectTable from 'components/table/project-table/filter-project-table/DeniedProjectTable';
...
export default function DeniedProjectList() {
  const { user } = useAuth();
  ...
  return (
    <Page title="Dự án đã bị từ chối| Krowd dành cho quản lý">
      <Container maxWidth={false}>
        {(isLoading && (
          ...
          (businessDetail?.status === 'ACTIVE' && <DeniedProjectTable />) || (
