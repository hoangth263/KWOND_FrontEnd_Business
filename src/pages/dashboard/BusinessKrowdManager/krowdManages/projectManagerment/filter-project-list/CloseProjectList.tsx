...
import ClosingProjectTable from 'components/table/project-table/filter-project-table/ClosingProjectTable';
...
export default function CloseProjectList() {
  ...
  return (
    <Page title="Dự án đã kết thúc | Krowd dành cho quản lý">
      <Container maxWidth={false}>
        {(isLoading && (
          ...
          (businessDetail?.status === 'ACTIVE' && <ClosingProjectTable />) || (
