...
import ActiveProjectTable from 'components/table/project-table/filter-project-table/ActiveProjectTable';
...
export default function ActiveProjectList() {
  ...
  return (
    <Page title="Dự án Đang hoạt động | Krowd dành cho quản lý">
      <Container maxWidth={false}>
        {(isLoading && (
          ...
          (businessDetail?.status === 'ACTIVE' && <ActiveProjectTable />) || (
