...
import WaitingToPublishProjectTable from 'components/table/project-table/filter-project-table/WaitingToPublishProjectTable';
...
export default function WaitingToPublishProjectList() {
  const { user } = useAuth();
  ...
  return (
    <Page title="Dự án đang chờ công khai | Krowd dành cho quản lý">
      <Container maxWidth={false}>
        {(isLoading && (
          ...
          (businessDetail?.status === 'ACTIVE' && <WaitingToPublishProjectTable />) || (
