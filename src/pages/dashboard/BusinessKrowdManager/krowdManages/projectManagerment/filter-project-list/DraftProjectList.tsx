...
import DraftProjectTable from 'components/table/project-table/filter-project-table/DraftProjectTable';
...
export default function DraftProjectList() {
  ...
  return (
    <Page title="Dự án đang khởi tạo| Krowd dành cho quản lý">
      <Container maxWidth={false}>
        {(isLoading && (
          ...
          (businessDetail?.status === 'ACTIVE' && <DraftProjectTable />) || (
