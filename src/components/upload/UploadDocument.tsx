...
export default function UploadDocument({ error, file, caption, sx, ...other }: UploadAvatarProps) {
    ...
    <>
      <RootStyle sx={sx}>
        ...
        >
          ...
          {file && <Input type="file" sx={{ zIndex: 8, objectFit: 'cover' }} />}
          ...
          >
            ...
            <Typography variant="caption">
              {file ? 'Cập nhật tài liệu' : 'Đăng tài liệu'}
            </Typography>
          </PlaceholderStyle>
        </DropZoneStyle>
      </RootStyle>
